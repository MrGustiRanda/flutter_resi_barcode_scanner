...
class _PickerScreenState extends State<PickerScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<Settings>(context).getPicker().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Provider.of<Settings>(context, listen: false).deletePicker(
                id.toString(),
              );

              Navigator.of(context).pushNamed(PickerScreen.routeName);
              setState(() {
                _isInit = true;
              });
            },
  ...
  Widget build(BuildContext context) {
    final pickers = Provider.of<Settings>(context).picker;
